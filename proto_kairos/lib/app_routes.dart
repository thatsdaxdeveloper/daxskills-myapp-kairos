...
import 'package:proto_kairos/views/pages/acting_pages/add_page.dart';
import 'package:proto_kairos/views/pages/onboarding_page.dart';

final appRouter = GoRouter(
  routes: [
    GoRoute(path: '/', builder: (context, state) => OnboardingPage(),),
    GoRoute(path: '/home', pageBuilder: (context, state) => buildFadeTransitionPage(ScaffoldControl()),),
    GoRoute(path: '/home/add', pageBuilder: (context, state) => buildFadeTransitionPage(AddPage()),),
  ]
);
